...
var status = Status(fatigue: 1, reps: 0, sets:  0, speed: 0, correctness: 100, weight: 3, exercise: 0, repLimit: 15, setLimit: 3)
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "DT.GymBuddy" in the application's documents Application Support directory.
